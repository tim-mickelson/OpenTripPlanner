...
public class TimeWindowTest extends TestCase {
    ...
    public void testIntervals() {
        ...
        assertEquals("ServiceForDate running, overlap should exist.", 500, tw.overlap(500, 1500, 2));
        ...
        assertEquals("ServiceForDate running, but interval entirely outside window.", 0, tw.overlap(3500, 4000, 4));
    }
