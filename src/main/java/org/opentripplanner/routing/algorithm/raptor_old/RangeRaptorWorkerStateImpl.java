...
import static org.opentripplanner.routing.algorithm.raptor_old.StopState.STOP_HEADERS;
...
public final class RangeRaptorWorkerStateImpl implements RangeRaptorWorkerState {
    ...
    @Override public void gotoNextRound () {
        ...
        //TODO Fix for no transit first round
        if (round == 1) {
            this.bestTransit.setTouched(0);
        }
    }
    ...
    public boolean isStopReached(int stop) {
        return bestOveral.isReached(stop);
    }
