...
public class PatternHop extends TablePatternEdge implements OnboardEdge, HopEdge {
    ...
    public State optimisticTraverse(State state0) {
    	...
    	s1.incrementWeight(options.getModeWeight(getMode()) * runningTime, "PatternHop optimisticTraverse");
    ...
    public State traverse(State s0) {
        ...
        s1.incrementWeight(options.getModeWeight(getMode()) * runningTime, "PatternHop traverse");
        s1.incrementTimeInSeconds(runningTime);
