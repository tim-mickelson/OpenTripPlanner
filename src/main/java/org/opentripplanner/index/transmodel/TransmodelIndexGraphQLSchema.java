...
public class TransmodelIndexGraphQLSchema {
    ...
    */
    ...
    private static GraphQLEnumType modeEnum = GraphQLEnumType.newEnum()
            ...
            // .value("coach", TraverseMode.COACH) TODO OTP2 Missing value
...
//                                                                        .build())
        ...
        tariffZoneType = GraphQLObjectType.newObject()
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        ...
                        .type(Scalars.GraphQLString)
                        .dataFetcher(
                                environment -> ((TariffZone) environment.getSource()).getId())
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("name")
                        .type(Scalars.GraphQLString)
        ...
        */
        ...
        stopPlaceType = GraphQLObjectType.newObject()
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        ...
                        .type(new GraphQLList(Scalars.GraphQLString))
                        .dataFetcher(environment -> ((Stop) environment.getSource()).getAdjacentSites())
                        .build())
                 */
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("timezone")
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        ...
                        .type(stopPlaceType)
                        .dataFetcher(environment -> getParentStopPlace(environment.getSource()))
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("estimatedCalls")
        ...
        lineType = GraphQLObjectType.newObject()
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        ...
                        .dataFetcher(environment -> {
                            ...
                            return index.noticeAssignmentForId.get(route.getId());
                        })
                        .build())
                /*
                .field(GraphQLFieldDefinition.newFieldDefinition()
        ...
        queryType = GraphQLObjectType.newObject()
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        ...
                        .dataFetcher(environment -> { Stream<Stop> stops= index.graph.streetIndex
                                ...
                                return stops.distinct().collect(Collectors.toList());
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        ...
                        .dataFetcher(environment -> getDefaultRoutingRequest(router))
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("notices")
    ...
    */
    ...
    private Stop getParentStopPlace(Stop stopPlace) {
        return index.stationForId.get(stopPlace.getParentStationId());
    }
