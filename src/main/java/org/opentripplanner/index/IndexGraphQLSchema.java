...
public class IndexGraphQLSchema {
    ...
    private GraphQLInterfaceType nodeInterface = relay.nodeInterface(environment -> {
        // TODO OTP2 - This is verified that it works, rewrite as a rusult of GraphQL update
