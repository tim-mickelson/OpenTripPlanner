...
echo "Downloading $FILENAME to $GRAPH_FILE_TARGET_PATH"
wget -nv $FILENAME -O $GRAPH_FILE_TARGET_PATH
FILESIZE=$(stat -c%s "$GRAPH_FILE_TARGET_PATH")
echo "Size of $FILENAME = $FILESIZE bytes."
echo "Downloading $ROUTER_CONFIG_URL to $ROUTER_CONFIG_TARGET_PATH"
