...
EXPOSE 8080
CMD ["java", "-Dtransmodel.graphql.api.agency.id=RB","-Dfile.encoding=UTF-8", "-Xms256m", "-Xmx6144m", "-server", "-jar", "otp-shaded.jar", "--server", "--graphs","/code/otpdata", "--router", "norway"]
